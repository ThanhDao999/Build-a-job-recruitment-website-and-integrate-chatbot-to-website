			...
			<div class="col-lg-8">
				<div class="card">
					<div class="card-header">
						<div class="row">
							<div class="col-lg-12">
								<span><large><b>Danh sách ứng tuyển</b></large></span>
								<button class="btn btn-sm btn-block btn-primary btn-sm col-md-2 float-right" type="button" id="new_application"><i class="fa fa-plus"></i> Thêm mới </button>
							</div>
						</div>
					...
					<div class="card-body">
						<div class="row">
							<div class="col-lg-12">
								<div class="row">
									<div class="col-md-2 offset-md-2 text-right">Vị trí :</div>
									<div class="col-md-5">
										<select name="" class="custom-select browser-default select2" id="position_filter">
											<option value="all"  <?php echo isset($position_id) && $position_id == "all" ? "selected" : '' ?>>Tất cả</option>
						...
						<table class="table table-bordered table-hover">
							...
							<thead>
								<tr>
									...
									<th class="text-center">Thông tin ứng tuyển</th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										<p>Tên : <b><?php echo ucwords($row['lastname'].', '.$row['firstname'].' '.$row['middlename']) ?></b></p>
										<p>Vị trí tuyển dụng : <b><?php echo $row['position'] ?></b></p>
									</td>
									<td class="text-center">
										<?php echo $stat_arr[$row['process_id']] ?>
									</td>
									<td class="text-center">
										<button class="btn btn-sm btn-primary view_application" type="button" data-id="<?php echo $row['id'] ?>" >Xem</button>
										<button class="btn btn-sm btn-primary edit_application" type="button" data-id="<?php echo $row['id'] ?>" >Sửa</button>
										<button class="btn btn-sm btn-danger delete_application" type="button" data-id="<?php echo $row['id'] ?>">Xóa</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
					...
					<div class="card-body">
						<div class="row">
							<div class="col-md-12 form-group">
								<button class="btn-block btn-sm btn filter_status" type="button" data-id="all">Tất cả</button>
							</div>
						</div>
...
<script>
	...
	$("#new_application").click(function(){
		uni_modal("Biểu mẫu tuyển dụng","manage_application.php","mid-large")
	})
