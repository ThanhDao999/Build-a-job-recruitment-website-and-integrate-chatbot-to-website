...
<div class="container-fluid">
	...
	<div class="col-md-12">
		...
		<div class="row form-group">
			...
			<div class="col-md-4">
				<label for="" class="control-label">Số điện thoại liên hệ</label>
				<input type="text" class="form-control" name="contact" required="" value="<?php echo isset($contact) ? $contact:''  ?>">
			</div>
		</div>
		<div class="row form-group">
			<div class="col-md-10">
				<label for="" class="control-label">Địa chỉ liên hệ</label>
				<textarea name="address" id="" cols="30" rows="3" required class="form-control"><?php echo isset($address) ? $address:''  ?></textarea>
			</div>
		</div>
		<div class="row form-group">
			<div class="col-md-10">
				<label for="" class="control-label">Thư ngỏ</label>
				<textarea name="cover_letter" id="" cols="30" rows="3" placeholder="" class="form-control"><?php echo isset($cover_letter) ? $cover_letter:''  ?></textarea>
			</div>
		</div>
		<div class="row form-group">
			<div class="input-group col-md-10 mb-3">
				<div class="input-group-prepend">
			    <span class="input-group-text" id="">Sơ yếu lý lịch</span>
			  </div>
		...
		<div class="row form-group">
			<div class="col-md-6">
				...
				<select class="custom-select browser-default select2" name="status">
					<option value="0" <?php echo isset($process_id) && $process_id == 0? "selected" : '' ?>>Mới</option>
