			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<div class="row">
							<div class="col-lg-12">
								<span><large><b>Danh sách tuyển dụng</b></large></span>
								<button class="btn btn-sm btn-block btn-primary btn-sm col-md-2 float-right" type="button" id="new_vacancy"><i class="fa fa-plus"></i>Thêm mới</button>
							</div>
						</div>
						...
						<table class="table table-bordered table-hover">
							...
							<thead>
								<tr>
									...
									<th class="text-center">Thông tin tuyển dụng</th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										<p>Vị trí : <b><?php echo $row['position'] ?></b></p>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-primary view_vacancy" type="button" data-id="<?php echo $row['id'] ?>" >Xem</button>
										<button class="btn btn-sm btn-primary edit_vacancy" type="button" data-id="<?php echo $row['id'] ?>" >Sửa</button>
										<button class="btn btn-sm btn-danger delete_vacancy" type="button" data-id="<?php echo $row['id'] ?>">Xóa</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
